...
CREATE TABLE IF NOT EXISTS "public"."order_items" (
    ...
    "quantity" real DEFAULT '1'::real NOT NULL,
...
CREATE POLICY "Allow everything for authenticated user" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "Allow everything to authenticated users" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);
